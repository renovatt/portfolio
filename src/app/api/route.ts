...
export async function POST(request: Request) {
  try {
    ...
    const {
      name,
      email,
      message } = contactSchema.parse(body)
      ...
      "embeds": [
        {
          ...
          "author": {
            ...
            "icon_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTg6e2GibzGWjfr21rRt-LFaZq8ayZgcYpxmw&usqp=CAU"
          },
          "footer": {
            "text": "Enviado pelo portfolio",
            "icon_url": "https://raw.githubusercontent.com/renovatt/portfolio/main/public/icon-512x512.png"
          },
          "thumbnail": {
